...
VL_INLINE_OPT void Vtop_delayed_pipe__Wa_D6___ico_sequent__TOP__mmacu__DOT__u_mmacu_core__DOT__ROW__BRA__0__KET____DOT__COL__BRA__5__KET____DOT__u_delay_b__0(Vtop_delayed_pipe__Wa_D6* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_delayed_pipe__Wa_D6___ico_sequent__TOP__mmacu__DOT__u_mmacu_core__DOT__ROW__BRA__0__KET____DOT__COL__BRA__5__KET____DOT__u_delay_b__0\n"); );
    ...
    vlSelfRef.o_out = vlSelfRef.genblk1__DOT__DELAY__BRA__5__KET____DOT__u_sr__DOT__o_data;
...
VL_INLINE_OPT void Vtop_delayed_pipe__Wa_D6___nba_sequent__TOP__mmacu__DOT__u_mmacu_core__DOT__ROW__BRA__0__KET____DOT__COL__BRA__5__KET____DOT__u_delay_b__0(Vtop_delayed_pipe__Wa_D6* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_delayed_pipe__Wa_D6___nba_sequent__TOP__mmacu__DOT__u_mmacu_core__DOT__ROW__BRA__0__KET____DOT__COL__BRA__5__KET____DOT__u_delay_b__0\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_INLINE_OPT void Vtop_delayed_pipe__Wa_D6___nba_sequent__TOP__mmacu__DOT__u_mmacu_core__DOT__ROW__BRA__0__KET____DOT__COL__BRA__5__KET____DOT__u_delay_b__1(Vtop_delayed_pipe__Wa_D6* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_delayed_pipe__Wa_D6___nba_sequent__TOP__mmacu__DOT__u_mmacu_core__DOT__ROW__BRA__0__KET____DOT__COL__BRA__5__KET____DOT__u_delay_b__1\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.genblk1__DOT__DELAY__BRA__0__KET____DOT__u_sr__DOT__i_data 

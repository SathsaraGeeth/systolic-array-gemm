...
VL_ATTR_COLD void Vtop_delayed_pipe__Wa_D8___ctor_var_reset(Vtop_delayed_pipe__Wa_D8* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_delayed_pipe__Wa_D8___ctor_var_reset\n"); );
    ...
    vlSelf->genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__i_clk = VL_RAND_RESET_I(1);
    vlSelf->genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__i_rst_n = VL_RAND_RESET_I(1);
    vlSelf->genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__i_clr_n = VL_RAND_RESET_I(1);
    vlSelf->genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__i_en = VL_RAND_RESET_I(1);
    vlSelf->genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__i_data = VL_RAND_RESET_I(10);
    vlSelf->genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__o_data = VL_RAND_RESET_I(10);
    vlSelf->genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__i_clk = VL_RAND_RESET_I(1);
    vlSelf->genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__i_rst_n = VL_RAND_RESET_I(1);
    vlSelf->genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__i_clr_n = VL_RAND_RESET_I(1);
    vlSelf->genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__i_en = VL_RAND_RESET_I(1);
    vlSelf->genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__i_data = VL_RAND_RESET_I(10);
    vlSelf->genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__o_data = VL_RAND_RESET_I(10);
}

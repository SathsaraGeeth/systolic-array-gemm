...
#ifndef VERILATED_VTOP_DELAYED_PIPE__WA_D5_H_
#define VERILATED_VTOP_DELAYED_PIPE__WA_D5_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_delayed_pipe__Wa_D5 final : public VerilatedModule {
  public:
    ...
    VlUnpacked<SData/*9:0*/, 6> genblk1__DOT__r_d;
    ...
    static constexpr IData/*31:0*/ DEPTH = 5U;
    ...
    // CONSTRUCTORS
    Vtop_delayed_pipe__Wa_D5(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_delayed_pipe__Wa_D5();
    VL_UNCOPYABLE(Vtop_delayed_pipe__Wa_D5);

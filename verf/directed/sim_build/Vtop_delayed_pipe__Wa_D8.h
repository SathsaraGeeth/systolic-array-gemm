...
#ifndef VERILATED_VTOP_DELAYED_PIPE__WA_D8_H_
#define VERILATED_VTOP_DELAYED_PIPE__WA_D8_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_delayed_pipe__Wa_D8 final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__i_clk;
    CData/*0:0*/ genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__i_rst_n;
    CData/*0:0*/ genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__i_clr_n;
    CData/*0:0*/ genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__i_en;
    CData/*0:0*/ genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__i_clk;
    CData/*0:0*/ genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__i_rst_n;
    CData/*0:0*/ genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__i_clr_n;
    CData/*0:0*/ genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__i_en;
    VL_IN16(i_in,9,0);
    VL_OUT16(o_out,9,0);
    ...
    SData/*9:0*/ genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__i_data;
    SData/*9:0*/ genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__o_data;
    SData/*9:0*/ genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__i_data;
    SData/*9:0*/ genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__o_data;
    VlUnpacked<SData/*9:0*/, 9> genblk1__DOT__r_d;
    ...
    static constexpr IData/*31:0*/ DEPTH = 8U;
    ...
    static constexpr IData/*31:0*/ genblk1__DOT__DELAY__BRA__6__KET____DOT__u_sr__DOT__WIDTH = 0x0000000aU;
    static constexpr IData/*31:0*/ genblk1__DOT__DELAY__BRA__7__KET____DOT__u_sr__DOT__WIDTH = 0x0000000aU;

    // CONSTRUCTORS
    Vtop_delayed_pipe__Wa_D8(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_delayed_pipe__Wa_D8();
    VL_UNCOPYABLE(Vtop_delayed_pipe__Wa_D8);

...
#ifndef VERILATED_VTOP_DELAYED_PIPE__WA_D7_H_
#define VERILATED_VTOP_DELAYED_PIPE__WA_D7_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_delayed_pipe__Wa_D7 final : public VerilatedModule {
  public:
    ...
    VlUnpacked<SData/*9:0*/, 8> genblk1__DOT__r_d;
    ...
    static constexpr IData/*31:0*/ DEPTH = 7U;
    ...
    // CONSTRUCTORS
    Vtop_delayed_pipe__Wa_D7(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_delayed_pipe__Wa_D7();
    VL_UNCOPYABLE(Vtop_delayed_pipe__Wa_D7);

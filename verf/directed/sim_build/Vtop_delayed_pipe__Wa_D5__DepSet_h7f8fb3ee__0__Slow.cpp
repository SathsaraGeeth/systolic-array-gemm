...
VL_ATTR_COLD void Vtop_delayed_pipe__Wa_D5___ctor_var_reset(Vtop_delayed_pipe__Wa_D5* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_delayed_pipe__Wa_D5___ctor_var_reset\n"); );

...
VL_ATTR_COLD void Vtop_delayed_pipe__Wa_D4___ctor_var_reset(Vtop_delayed_pipe__Wa_D4* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_delayed_pipe__Wa_D4___ctor_var_reset\n"); );

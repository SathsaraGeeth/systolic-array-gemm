...
#ifndef VERILATED_VTOP_DELAYED_PIPE__WA_D4_H_
#define VERILATED_VTOP_DELAYED_PIPE__WA_D4_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_delayed_pipe__Wa_D4 final : public VerilatedModule {
  public:
    ...
    VlUnpacked<SData/*9:0*/, 5> genblk1__DOT__r_d;
    ...
    // CONSTRUCTORS
    Vtop_delayed_pipe__Wa_D4(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_delayed_pipe__Wa_D4();
    VL_UNCOPYABLE(Vtop_delayed_pipe__Wa_D4);
